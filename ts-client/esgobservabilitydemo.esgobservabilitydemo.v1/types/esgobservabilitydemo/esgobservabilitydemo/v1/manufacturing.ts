...
function createBaseManufacturing(): Manufacturing {
  return { id: Long.UZERO, componentType: "", waterUse: "", emissions: "", creator: "" };
}

export const Manufacturing: MessageFns<Manufacturing> = {
  encode(message: Manufacturing, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Manufacturing {
  ...
  create<I extends Exact<DeepPartial<Manufacturing>, I>>(base?: I): Manufacturing {
    return Manufacturing.fromPartial(base ?? ({} as any));
  },
