...
function createBaseMaterialProcessing(): MaterialProcessing {
  return { id: Long.UZERO, materialType: "", waterUse: "", emissions: "", creator: "" };
}

export const MaterialProcessing: MessageFns<MaterialProcessing> = {
  encode(message: MaterialProcessing, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MaterialProcessing {
  ...
  create<I extends Exact<DeepPartial<MaterialProcessing>, I>>(base?: I): MaterialProcessing {
    return MaterialProcessing.fromPartial(base ?? ({} as any));
  },
