...
function createBaseRawMaterialExtraction(): RawMaterialExtraction {
  return { id: 0, resourceType: "", waterUse: "", emissions: "", creator: "" };
}

export const RawMaterialExtraction = {
  encode(message: RawMaterialExtraction, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): RawMaterialExtraction {
