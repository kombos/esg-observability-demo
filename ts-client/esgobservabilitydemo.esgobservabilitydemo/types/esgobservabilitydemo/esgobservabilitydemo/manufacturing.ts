...
function createBaseManufacturing(): Manufacturing {
  return { id: 0, componentType: "", waterUse: "", emissions: "", creator: "" };
}

export const Manufacturing = {
  encode(message: Manufacturing, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Manufacturing {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseManufacturing();
  ...
  fromJSON(object: any): Manufacturing {
    return {
  ...
  toJSON(message: Manufacturing): unknown {
    const obj: any = {};
  ...
  fromPartial<I extends Exact<DeepPartial<Manufacturing>, I>>(object: I): Manufacturing {
    const message = createBaseManufacturing();
