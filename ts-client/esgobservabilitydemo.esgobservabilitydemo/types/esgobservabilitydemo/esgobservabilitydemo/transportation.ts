...
function createBaseTransportation(): Transportation {
  return { id: 0, transportationType: "", fuelUse: "", emissions: "", creator: "" };
}

export const Transportation = {
  encode(message: Transportation, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Transportation {
